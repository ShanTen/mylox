...
public class TestingStuff {
    ...
    static List<String> expressions = Arrays.asList(
    ...
    static String className = "Expr";
    // Using STR templates (Java 21 preview) for the output filename
    static String fout = STR."/home/shanten/MyCode/java/my-lox/src/com/playpen/sandpit/\{className}.java";
    ...
    private static void writeOverridenAcceptMethod(PrintWriter writer, String exprType) {
        ...
        writer.println(STR."            return visitor.visit\{exprType}Expr(this);");
        writer.println("        }");
    }
    ...
    private static void writeVisitMethod(PrintWriter writer, String exprType) {
        writer.println(STR."        R visit\{exprType}Expr(\{exprType} expr);");
    }
